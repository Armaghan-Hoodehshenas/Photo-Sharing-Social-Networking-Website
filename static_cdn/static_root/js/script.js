jQuery(document).ready(function ($) {
	...
	jQuery(".post-comt-box textarea").on("keydown", function (event) {
		...
		if (event.keyCode == 13) {
			...
			var comment_HTML = '	<li><div class="comet-avatar"><img src="images/resources/comet-1.jpg" alt=""></div><div class="we-comment"><div class="coment-head"><h5><a href="time-line.html" title="">علی محمدی</a></h5><span>1 سال قبل</span><a class="we-reply" href="#" title="پاسخ"><i class="fa fa-reply"></i></a></div><p>' + comment + '</p></div></li>';
